...
.nav__logo-img { height: 20px; width: auto; object-fit: contain; opacity: .9; transition: opacity .2s; }
...
.footer__logo-img { height: 64px; width: auto; object-fit: contain; margin-bottom: 16px; display: block; }
