...
export default function STBStore() {
  ...
  const goToStory = () => { setPage("story"); window.scrollTo({ top: 0 }); };
            ...
            <div className="story__body">
              <div className="story__section">
                ...
                <p className="story__text">
                  STB was built on one belief: excellence should be accessible.
                  What started as a vision between New York and Los Angeles became
                  a movement &mdash; a brand for those who refuse to settle for anything
                  less than the best.
                </p>
              </div>
              ...
              <div className="story__section">
                ...
                <p className="story__text">
                  From the streets of New York to the coasts of Los Angeles,
                  every piece is designed with intention &mdash; for those who move
                  with purpose. We don&apos;t follow trends. We set the standard.
                </p>
              </div>
              ...
              <div className="story__section">
                ...
                <p className="story__text">
                  Strictly Thee Best isn&apos;t just a name &mdash; it&apos;s a promise.
                  A promise that quality, design, and craftsmanship belong to everyone.
                  Every collection, every drop, every detail is made with one goal:
                  to give you the best, nothing less.
                </p>
              </div>
...
.story__back {
  ...
  margin-bottom: 48px; display: block; padding: 0;
  transition: color .2s;
}
...
.story__headline {
  font-family: 'Cormorant Garamond', serif;
  font-weight: 300; font-size: clamp(44px, 5.5vw, 80px);
  line-height: 1.05; color: var(--cream); margin-top: 16px;
}
.story__headline em { font-style: italic; color: var(--gold); }

.story__body {
  max-width: 720px; padding: 96px 64px 120px;
}
...
@media (max-width: 768px) {
  ...
  .story__hero { padding: 100px 32px 60px; }
  .story__body { padding: 64px 32px 80px; }
}
`;
